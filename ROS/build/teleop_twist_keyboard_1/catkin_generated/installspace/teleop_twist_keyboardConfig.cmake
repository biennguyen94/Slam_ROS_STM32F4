...
if("FALSE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/biennguyen/catkin_ws/src/teleop_twist_keyboard_1)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/biennguyen/catkin_ws/install/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
