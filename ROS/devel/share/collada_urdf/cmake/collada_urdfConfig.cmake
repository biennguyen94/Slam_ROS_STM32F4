...
if("TRUE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /home/biennguyen/catkin_ws/src/robot_model/collada_urdf)
  set(collada_urdf_DEVEL_PREFIX /home/biennguyen/catkin_ws/devel)
  ...
  set(collada_urdf_INSTALL_PREFIX /home/biennguyen/catkin_ws/install)
...
if(NOT "/home/biennguyen/catkin_ws/src/robot_model/collada_urdf/include " STREQUAL " ")
  set(collada_urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/biennguyen/catkin_ws/src/robot_model/collada_urdf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/biennguyen/catkin_ws/src/robot_model/collada_urdf/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
