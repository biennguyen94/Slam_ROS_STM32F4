...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/biennguyen/catkin_ws/src/robot_model/urdf)
  set(urdf_DEVEL_PREFIX /home/biennguyen/catkin_ws/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/biennguyen/catkin_ws/install)
...
if(NOT "/home/biennguyen/catkin_ws/src/robot_model/urdf/include;/usr/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/biennguyen/catkin_ws/src/robot_model/urdf/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/biennguyen/catkin_ws/src/robot_model/urdf/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
